...
resource "cloudflare_zone_dnssec" "devops_akademie_cz" {
  zone_id = cloudflare_zone.devops_akademie_cz.id
  status  = "active"
}

resource "cloudflare_zone_setting" "devops_akademie_cz_always_use_https" {
  zone_id    = cloudflare_zone.devops_akademie_cz.id
  setting_id = "always_use_https"
  value      = "on"
}

resource "cloudflare_zone_setting" "devops_akademie_cz_automatic_https_rewrites" {
  zone_id    = cloudflare_zone.devops_akademie_cz.id
  setting_id = "automatic_https_rewrites"
  value      = "on"
}

resource "cloudflare_zone_setting" "devops_akademie_cz_ssl" {
  zone_id    = cloudflare_zone.devops_akademie_cz.id
  setting_id = "ssl"
  value      = "full"
}
...
resource "cloudflare_zone_dnssec" "devopsakademie_cz" {
  zone_id = cloudflare_zone.devopsakademie_cz.id
  status  = "active"
}

resource "cloudflare_zone_setting" "devopsakademie_cz_always_use_https" {
  zone_id    = cloudflare_zone.devopsakademie_cz.id
  setting_id = "always_use_https"
  value      = "on"
}

resource "cloudflare_zone_setting" "devopsakademie_cz_automatic_https_rewrites" {
  zone_id    = cloudflare_zone.devopsakademie_cz.id
  setting_id = "automatic_https_rewrites"
  value      = "on"
}

resource "cloudflare_zone_setting" "devopsakademie_cz_ssl" {
  zone_id    = cloudflare_zone.devopsakademie_cz.id
  setting_id = "ssl"
  value      = "full"
}
